		    ...
		    out.write("<h2>사원 정보 수정</h2>");
		    	...
		    	out.write("<form method=post action=EmpUpdateServlet>");
			    	out.write("<table class=table>");
			    		...
			    		out.write("<tr>");
				    		out.write("<th width=20% class=\"text-right success\">사수 번호</th>");
				    		out.write("<td width=80%>");
			    		...
			    		out.write("<tr>");
				    		out.write("<td colspan=2 class=text-center>");
				    			out.write("<button class=\"btn btn-sm btn-success\">수정</button>&nbsp;");
				    			out.write("<input type=button value=취소 class=\"btn btn-sm btn-danger\" onclick=\"javascript:history.back()\">");
				    		out.write("</td>");
			    		out.write("</tr>");
