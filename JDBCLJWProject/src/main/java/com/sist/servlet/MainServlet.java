...
public class MainServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.write("	        <ul class=\"dropdown-menu\">");
	    out.write("	          <li><a href=\"MainServlet?mode=5&type=1\">부서별 통계</a></li>");
	    out.write("	          <li><a href=\"MainServlet?mode=5&type=2\">직위별 통계</a></li>");
	    out.write("	          <li><a href=\"MainServlet?mode=5&type=3\">입사년도별 통계</a></li>");
	    out.write("	        </ul>");
	    out.write("	      </li>");
