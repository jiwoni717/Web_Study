...
<%
	...
	String addr1 = address.substring(0, address.lastIndexOf("지번")-1);
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0dd4ced166140773f124f5539c2e030f&libraries=services"></script>
</head>
<body>
	<div class="container">
		<div class="row">
			<table class="table">
				<tr>
					<c:forTokens items="${vo.poster }" delims="^" var="img">
						<td>
							<img src="${img }" style="width: 100%;height: ">
						</td>
					</c:forTokens>
				</tr>
			</table>
		...
		<div class="row">
			<div class="col-sm-7">
				<table class="table">
					...
					<tr>
						<th width=15% style="color:orange">주소</th>
						<td width=85%>
							${addr1 }<br>
							<sub style="color:grey">지번 : ${addr2 }</sub>
						</td>
					</tr>
					<tr>
						<th width=15% style="color:orange">전화</th>
						<td width=85%>${vo.phone }</td>
					</tr>
					<tr>
						<th width=15% style="color:orange">음식 종류</th>
						<td width=85%>${vo.type }</td>
					</tr>
					<tr>
						<th width=15% style="color:orange">가격대</th>
						<td width=85%>${vo.price }</td>
					</tr>
					<tr>
						<th width=15% style="color:orange">주차</th>
						<td width=85%>${vo.parking }</td>
					</tr>
					<tr>
						<th width=15% style="color:orange">영업시간</th>
						<td width=85%>${vo.time }</td>
					</tr>
					<c:if test="${vo.menu!='no' }">
					<tr>
						<th width=15% style="color:orange">메뉴</th>
						<td width=85%>
							<ul>
