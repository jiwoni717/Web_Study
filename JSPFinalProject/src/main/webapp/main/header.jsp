...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      <ul class="inline">
        <li><i class="fa-sharp fa-regular fa-arrow-right-to-bracket"></i><input type=text name=id class="input-sm" size=10></li>
        <li><input type=password name=pwd class="input-sm" size=10></li>
        <li><input type=button value="로그인" class="btn btn-danger"></li>
      </ul>
    </div>
    <!-- ################################################################################################ --> 
  </header>
