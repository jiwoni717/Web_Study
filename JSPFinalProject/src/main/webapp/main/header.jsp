  ...
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      <c:if test="${sessionScope.id==null }">
	      <ul class="inline">
	        <li><i class="fa-sharp fa-regular fa-arrow-right-to-bracket"></i><input type=text name=id class="input-sm" size=10 id=id></li>
	        <li><input type=password name=pwd class="input-sm" size=10 id=pwd></li>
	        <li><input type=button value="로그인" class="btn btn-danger" id="logBtn"></li>
	      </ul>
      </c:if>
      ...
      <c:if test="${sessionScope.id!=null }">
	      <ul class="inline">
	        ...
	        <li><input type=button value="로그아웃" class="btn btn-danger" id="logoutBtn"></li>
	      </ul>
      </c:if>
    </div>
    <!-- ################################################################################################ --> 
  ...
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      ...
      <li><a class="drop" href="#">맛집</a>
        <ul>
          <li><a href="../food/location_find.do">지역별 맛집 찾기</a></li>
          <%--
          	session.Scope.id
      ...
      <li><a class="drop" href="#">서울 여행</a>
        <ul>
          ...
          <c:if test="${sessionScope.id!=null }">
          	<li><a href="pages/sidebar-left.html">여행 코스</a></li>
          </c:if>
        </ul>
      </li>
