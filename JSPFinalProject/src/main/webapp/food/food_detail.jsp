  				...
  				<table class="table">
  					...
  					<tr>
  						<td colspan=2 class="text-right">
  							<a href="#" class="btn btn-xs btn-default">찜하기</a>
  							<a href="#" class="btn btn-xs btn-default">좋아요(0)</a>
  							<a href="#" class="btn btn-xs btn-danger">예약</a>
  							<a href="../food/food_category_list.do?cno=${vo.cno }" class="btn btn-xs btn-default">목록</a>
  						</td>
  					</tr>
  				</table>
