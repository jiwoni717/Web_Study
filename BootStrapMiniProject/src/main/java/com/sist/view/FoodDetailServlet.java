...
public class FoodDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String addr1=addr.substring(0,addr.lastIndexOf("지번")).trim();
		String addr2=addr.substring(addr.lastIndexOf("지번")+3).trim();
		...
		out.println("<table class=table>");
		out.println("<tr>");
		out.println("<th width=20% width=20%>주소</th>");
		out.println("<td width=80%>"+addr1+"<br><sub>지번:"+addr2+"</sub><br></td>");
		out.println("</tr>");
		out.println("<tr>");
